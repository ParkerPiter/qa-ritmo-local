...
// Historial de pagos/splits recibidos por el artist, partner, promoter o venue
connectRoutes.get('/payouts', authenticateToken, requireRoles(['artist', 'partner', 'promoter', 'venue']), connectController.getPayouts);
